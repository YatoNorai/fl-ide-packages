...
termux_step_pre_configure() {
	...
	# https://github.com.yato.fl_ide/termux-packages/issues/11427
	# Fresh build conflict: liblzma -> rust
<<<<<<< HEAD
	# ld: error: /data/data/com.yato.fl_ide/files/usr/lib/liblzma.a(liblzma_la-common.o) is incompatible with elf64-x86-64
